                    ...
                    <ul class="nav nav-pills" id="myTab3" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link bar {{ has_key(['supplier_name'],$errors) ? 'error' : '' }}"
                                ...
                                aria-selected="false">{{ __('Supplier Details') }}
                            </a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-8 col-lg-9 middle">
                        <div class="tab-content no-padding" id="myTabContent2">
                            ...
                            <div class="tab-pane fade show active" id="supplier_id" role="tabpanel">
                                <div class="card">
                                    <div class="card-header extra-padding">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @foreach($suppliers as $supplier)
                                            <div class="collapse supplier-details mt-5 {{ (old('supplier_id') ?? $product->supplier_id ?? '') == $supplier->id ? 'show' : '' }}" 
